...
is a hard wall: Common gives about 1,000 words, Familiar about 3,800, Insane **22,645**.
...
than in (`c`: 5,103 words start with it, 398 end with it) and some are the reverse (`e`: 8,340 in,
1,946 out), so a chain must strand the excess. The game works out the smallest possible number to
strand and then walks everything that is left.

## What counts as a word

The list is **SEN**, the Single English Nouns dataset: 60,979 words, 50,010 of them playable at
...
The playable words by tier: 435 core · 2,254 common · 6,869 familiar · 11,697 uncommon ·
13,024 rare · 15,731 obscure. That last band is words the frequency tables have never seen — real
